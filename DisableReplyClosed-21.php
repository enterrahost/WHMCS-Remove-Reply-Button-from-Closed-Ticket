...
| The viewticket.tpl also needs to be updated as does the LANG file
|
| For WHMCS Twenty One Based Templates
| - Enterrahost
*/
            ...
            return [
                ...
                'additionalCSS' => ($ticket->status == 'Closed') ? 
                    '.btn-success[onclick*="ticketReply"] { display: none !important; }
                     #ticketReplyContainer { display: none !important; }
                     #ticketReply { display: none !important; }' : ''
            ];
        }
    }
    return [];
